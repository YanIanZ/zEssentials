...
public enum Permission {
    ...
    ESSENTIALS_CHAT_DND("Toggle do not disturb mode for chat mentions"),
    ...
    ESSENTIALS_POLLS_USE("Answer a poll"),
    ESSENTIALS_POLLS_ADMIN("Create and stop polls"),
    ESSENTIALS_REPUTATION_USE("Use the reputation commands"),
    ESSENTIALS_WARNINGS_VIEW("View the warnings of a player"),
    ESSENTIALS_NOTES("View and manage private staff notes"),
    ESSENTIALS_NOTES_MANAGE("Add and clear staff notes"),
    ESSENTIALS_NICKNAMES_USE("Change your own nickname"),
    ESSENTIALS_NICKNAMES_OTHER("Change the nickname of another player"),
