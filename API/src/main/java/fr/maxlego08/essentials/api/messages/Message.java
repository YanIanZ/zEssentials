...
public enum Message {
    ...
    COMMAND_ENDERSEE_READONLY("#656665You are viewing this ender chest in read-only mode."),
    ...
    COMMAND_VANISH_TOGGLED_OTHER("&7You just toggled vanish for &f%player%<success> &7(they are now &f%state%&7)."),
    ...
    DESCRIPTION_TOAST("Show a custom advancement toast popup"),
    COMMAND_TOAST_SENT("<success>Toast sent successfully."),
    COMMAND_TOAST_SENT_OTHER("<success>Toast sent to &f%player%<success>."),
    COMMAND_TOAST_RECEIVED("<success>You received a toast from &f%player%<success>."),
    ...
    DESCRIPTION_WORLDEDIT("Manage the player worldedit feature"),
    DESCRIPTION_ESSENTIALS("Main zEssentials command"),
    DESCRIPTION_ESSENTIALS_CONVERT("Convert player data from another essentials plugin"),
    DESCRIPTION_VAULT("Open your personal vault"),
    ...
    DESCRIPTION_REALNAME("Reveal the real name of a disguised player"),
    ...
    NICK_CHANGED("<success>Your nickname is now &f%nickname%<success>."),
    ...
    NICK_FETCH_FAILED("<error>Failed to fetch the identity of &f%player%<error>. Try again later."),
    ...
    DISGUISE_LIST_HEADER("#656665Available random disguises&8:"),
    DISGUISE_LIST_ENTRY("#656665» &f%name%"),
    DISGUISE_FETCHING("#656665Fetching skin from Mojang&8..."),
    DISGUISE_FETCH_FAILED("<error>Failed to fetch skin for &f%player%<error>. Please try again later."),
    DISGUISE_USAGE("<error>Usage&7: &f/disguise <player> &7| &f/disguise random &7| &f/disguise skin <texture> [signature] &7| &f/disguise mob <type> &7| &f/disguise off &7| &f/disguise list"),
    DISGUISE_DISABLED("<error>The disguise system is disabled."),
    DISGUISE_MOB("<success>You are now disguised as a &f%type%<success>."),
    DISGUISE_MOB_OTHER("<success>You disguised &f%player% <success>as a &f%type%<success>."),
    DISGUISE_INVALID_MOB("<error>Unknown mob type&7: &f%type%<error>. Try ZOMBIE, SKELETON, CREEPER, etc."),
    DISGUISE_BABY_SET("<success>The disguise is now a baby."),
    DISGUISE_ADULT_SET("<success>The disguise is now an adult."),
    DISGUISE_PROFESSION_SET("<success>Villager profession set to &f%profession%<success>."),
    DISGUISE_PROFESSION_INVALID("<error>Unknown profession&7: &f%profession%<error>. Try FARMER, LIBRARIAN, CLERIC, etc."),
    DISGUISE_SIZE_SET("<success>Slime size set to &f%size%<success>."),
    DISGUISE_SIZE_INVALID("<error>Invalid size&7: &f%size%<error>. Must be a number between 1 and 50."),
    DISGUISE_VILLAGER_TYPE_SET("<success>Villager type set to &f%type%<success>."),
    STASH_WITHDRAW_ALL_SUCCESS("<success>Withdrew &f%count% <success>items from your stash."),
    STASH_EMPTY("<error>Your stash is empty."),
    REALNAME_REVEALED("#656665The real name of &f%disguise% #656665is &f%realname%&7."),
    REALNAME_NOT_DISGUISED("#656665That player is not disguised."),
