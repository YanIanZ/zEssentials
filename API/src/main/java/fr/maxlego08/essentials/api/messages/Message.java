...
public enum Message {
    ...
    DESCRIPTION_ITEM_GLOW("Toggle the enchantment glint on your item"),
    DESCRIPTION_ITEM_UNBREAKABLE("Toggle the unbreakable flag on your item"),
    DESCRIPTION_ITEM_MODEL_DATA("Set the custom model data of your item"),
    DESCRIPTION_CONDENSE("Condense loose items into blocks"),
    DESCRIPTION_HOMES_GUI("Open the homes screen"),
    DESCRIPTION_KITS_GUI("Open the kits screen"),
    DESCRIPTION_WARPS_GUI("Open the warp selection screen"),
    DESCRIPTION_BALTOP_GUI("Open the balance top screen"),
    COMMAND_CONDENSE_SUCCESS("Condensed %amount% block(s)."),
    COMMAND_CONDENSE_EMPTY("No items to condense."),
    COMMAND_TRASH_OPENED("Trash inventory opened. Click items to destroy them."),
    COMMAND_NEAR_INVALID_RADIUS("Invalid radius, using default (%default%)."),
    ...
    DESCRIPTION_POLL("Vote on the running poll"),
    POLL_INVALID_USAGE("<error>Usage&7: /poll create <seconds> <question> | <option 1> | <option 2> ..."),
    POLL_CREATE_FAILED("<error>Impossible to create the poll."),
        DESCRIPTION_REPUTATION("Show your reputation score"),
    DESCRIPTION_REPUTATION_GIVE("Give a reputation point to a player"),
    REPUTATION_SCORE("&f%player% &7has &#a7ff33%score% &7reputation point(s)."),
    REPUTATION_GIVEN("&#a7ff33+1 &7reputation given to &f%player% &8(&7total: &f%score%&8)"),
    REPUTATION_SELF("<error>You cannot give reputation to yourself."),
    REPUTATION_ALREADY("<error>You already gave reputation to this player recently&7, wait &f%hours%h<error>."),
        RAID_ALERT(MessageType.WITHOUT_PREFIX, "&#ff4d4d&l⚠ RAID ALERT &#7fff%amount% &#ffffffsimilar messages detected: §o%message%"),
        DESCRIPTION_WARN("Issue a warning to a player"),
    DESCRIPTION_WARNINGS("List the warnings of a player"),
    WARNINGS_HEADER("&8&m--------&#ff4d4d Warnings of &f%player% &8(&f%count%&8) &8&m--------"),
    WARNINGS_LINE(" &#ff9d4d• &7[%date%] &f%reason%"),
    DESCRIPTION_NOTES("View or manage the private staff notes"),
    NOTES_HEADER("&8&m--------&#00d4ff Notes of &f%player% &8(&f%count%&8) &8&m--------"),
    NOTES_LINE(" §7[%date% §8| §f%staff%§7] §f%note%"),
    NOTE_ADDED("<success>Note added for &f%player%<success>."),
    NOTES_CLEARED("<success>Removed &f%count% <success>note(s) of &f%player%<success>."),
        DESCRIPTION_NICK("Change your nickname"),
    NICK_SET("<success>Nickname of &f%player% <success>is now&f: %nickname%"),
    NICK_REMOVED("<success>Nickname of &f%player% <success>has been removed."),
    NICK_TOO_LONG("<error>This nickname is too long&7, maximum &f%max% <error>characters."),
    NICK_INVALID_CHARACTERS("<error>This nickname contains forbidden characters."),
    NICK_COLORS_NOT_ALLOWED("<error>You cannot use colors in your nickname."),
    NICK_IMPERSONATION("<error>You cannot take the name of another player."),
    NICK_COOLDOWN("<error>Wait &f%seconds%s <error>before changing your nickname again."),
        DESCRIPTION_REPORT("Report a player to the staff"),
    REPORT_COOLDOWN("<error>Wait &f%seconds%s <error>before sending another report."),
    REPORT_SELF("<error>You cannot report yourself."),
    REPORT_UNKNOWN_ID("<error>No report with the id &f%id%<error>."),
    REPORT_TARGET_OFFLINE("<error>The reported player is offline, teleport cancelled."),
    REPORT_TELEPORTED("<success>Teleported to &f%player%<success>."),
    ...
    DESCRIPTION_TAGS("Open the chat tag selection"),
        REPLY_NO_TARGET("<error>You have nobody to reply to yet."),
        DESCRIPTION_EAT("Fill hunger and saturation instantly"),
    COMMAND_EAT_SUCCESS("<success>Hunger restored&7, bon appétit!"),
    DESCRIPTION_XYZ("Copy your coordinates to the clipboard"),
    COMMAND_XYZ_COPIED("<success>Coordinates copied to clipboard&7: &f%coords%"),
    ...
    DESCRIPTION_CHAT_DND("Toggle do not disturb for chat mentions"),
    COMMAND_CHAT_DND_ENABLE("<success>Do not disturb enabled&7, you will not receive mention notifications."),
    COMMAND_CHAT_DND_DISABLE("<success>Do not disturb disabled&7, mention notifications are back."),
    DESCRIPTION_CHAT_SLOWMODE("Set a slowmode between each chat message"),
    COMMAND_CHAT_SLOWMODE_SET("<success>Chat slowmode set to &f%seconds%s<success>."),
    COMMAND_CHAT_SLOWMODE_OFF("<success>The chat slowmode has been disabled."),
    COMMAND_CHAT_SLOWMODE_WAIT("<error>Slowmode is active&7, wait &f%cooldown%<error> before talking again."),
