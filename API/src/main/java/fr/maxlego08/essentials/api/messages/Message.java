...
public enum Message {
    ...
    NICK_RANDOMIZING("<7>Randomizing your identity&8..."),
    ...
    REALNAME_REVEALED("<7>The real name of &f%disguise% <7>is &f%realname%<7>."),
    REALNAME_NOT_DISGUISED("<7>That player is not disguised."),
