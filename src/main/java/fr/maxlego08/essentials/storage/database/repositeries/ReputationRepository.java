...
public class ReputationRepository extends Repository {
    public ReputationRepository(EssentialsPlugin plugin, DatabaseConnection connection) {
        super(plugin, connection, "reputations");
    }
