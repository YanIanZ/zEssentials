...
public class DisguiseRepository extends Repository {
    public DisguiseRepository(EssentialsPlugin plugin, DatabaseConnection connection) {
        super(plugin, connection, "disguises");
    }
