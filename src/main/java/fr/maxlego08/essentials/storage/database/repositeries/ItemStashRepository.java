...
public class ItemStashRepository extends Repository {
    public ItemStashRepository(EssentialsPlugin plugin, DatabaseConnection connection) {
        super(plugin, connection, "stash_items");
    }
