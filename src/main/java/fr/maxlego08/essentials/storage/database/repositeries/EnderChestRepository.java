...
public class EnderChestRepository extends Repository {
    public EnderChestRepository(EssentialsPlugin plugin, DatabaseConnection connection) {
        super(plugin, connection, "enderchest");
    }
