...
public class MaterialStashRepository extends Repository {
    public MaterialStashRepository(EssentialsPlugin plugin, DatabaseConnection connection) {
        super(plugin, connection, "stash_materials");
    }
