...
public class MongoDisguiseRepository extends MongoRepository {
    public MongoDisguiseRepository(EssentialsPlugin plugin, MongoDatabase database) {
        super(plugin, database, "disguises");
    }
