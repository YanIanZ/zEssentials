...
public class MongoReputationRepository extends MongoRepository {
    public MongoReputationRepository(EssentialsPlugin plugin, MongoDatabase database) {
        super(plugin, database, "reputations");
    }
