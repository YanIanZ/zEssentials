...
public class MongoChatPreferenceRepository extends MongoRepository {
    public MongoChatPreferenceRepository(EssentialsPlugin plugin, MongoDatabase database) {
        super(plugin, database, "chat_preferences");
    }
    ...
    public Map<UUID, String> getAll() {
        ...
        for (Document doc : collection().find()) {
            try {
                map.put(UUID.fromString(doc.getString("uuid")), doc.getString("data_json"));
