...
public class MongoEnderChestRepository extends MongoRepository {
    public MongoEnderChestRepository(EssentialsPlugin plugin, MongoDatabase database) {
        super(plugin, database, "enderchest");
    }
